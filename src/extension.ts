...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(
		...
		vscode.commands.registerCommand('chatgpt.reviewCode', () => commandHandler('promptPrefix.reviewCode')),
		vscode.commands.registerCommand('chatgpt.jsToTs', () => commandHandler('promptPrefix.jsToTs')),
		vscode.commands.registerCommand('chatgpt.checkW3cAccessibility', () => commandHandler('promptPrefix.checkW3cAccessibility')),
		vscode.commands.registerCommand('chatgpt.documentation', () => commandHandler('promptPrefix.documentation')),
		vscode.commands.registerCommand('chatgpt.addUnitTests', () => commandHandler('promptPrefix.addUnitTests')),
		vscode.commands.registerCommand('chatgpt.alternate', () => commandHandler('promptPrefix.alternate')),
		vscode.commands.registerCommand('chatgpt.translate', () => commandHandler('promptPrefix.translate')),
